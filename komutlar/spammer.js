...
if (isNaN(sayi)) return message.channel.send(`${basarisiz} ${message.author}, ${db.fetch(`prefix`) || ayarlar.prefix}spam <sayı> <mesaj> şeklinde yazınız.`).then(x => x.delete({timeout: 5000}))
