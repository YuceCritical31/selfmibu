...
let kanal = message.channels.mentions.firts()
if(!args[0]) return message.channel.send(`${basarisiz} ${message.author}, Lütfen bir kanal belirtiniz.`).then(x => x.delete({timeout: 5000}));
