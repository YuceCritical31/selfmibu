...
//}, 5000)
client.user.setPresence({ activity: {name: "Spotify", type: "LISTENING", details: "Another Love", state: "Tom Odell", timestamps: { start: Date.now(), end: Date.now() + ((4 * 60 * 60) + (4 * 60))}, party: {id:`spotify:${client.user.id}`}, assets: {largeText: "Long Way Down (Expanded Edition)", largeImage: "spotify:ab67616d0000b2739adb17697c5a5bb02b5cebb7"}, syncID: "5E4jBLx4P0UBji68bBThSw"}, status: status})
